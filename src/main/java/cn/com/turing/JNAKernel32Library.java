...
final class JNAKernel32Library {
    ...
    private List<JNAKernel32Library.NativeHandlerCallback> callbacks = new ArrayList<JNAKernel32Library.NativeHandlerCallback>();
    ...
    static JNAKernel32Library getInstance() {
        return JNAKernel32Library.Holder.instance;
    }
    ...
    boolean addConsoleCtrlHandler(ConsoleCtrlHandler handler) {
        ...
        if (handler != null) {
            JNAKernel32Library.NativeHandlerCallback callback = new JNAKernel32Library.NativeHandlerCallback(handler);
    ...
    public static class MemoryBasicInformation extends Structure {
        ...
        public JNAKernel32Library.SizeT RegionSize;
     ...
     */
    native boolean VirtualLock(Pointer address, JNAKernel32Library.SizeT size);
     ...
     */
    native int VirtualQueryEx(Pointer handle, Pointer address, JNAKernel32Library.MemoryBasicInformation memoryInfo, int length);
     ...
     * @return true if the function succeeds.
     */
    native boolean SetProcessWorkingSetSize(Pointer handle, JNAKernel32Library.SizeT minSize, JNAKernel32Library.SizeT maxSize);
    ...
    public static class JOBOBJECT_BASIC_LIMIT_INFORMATION extends Structure implements Structure.ByReference {
        ...
        public JNAKernel32Library.SizeT MinimumWorkingSetSize;
        public JNAKernel32Library.SizeT MaximumWorkingSetSize;
